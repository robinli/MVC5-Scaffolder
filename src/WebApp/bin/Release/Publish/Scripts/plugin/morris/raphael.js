    ...
    function(window, eve) {
        ...
        var loaded,
            ...
            rectPath = R._rectPath = function(x, y, w, h, r) {
                if (r) {
                    return [
                        ["M", x + r, y], ["l", w - r * 2, 0], ["a", r, r, 0, 0, 1, r, r], ["l", 0, h - r * 2],
                        ["a", r, r, 0, 0, 1, -r, r], ["l", r * 2 - w, 0], ["a", r, r, 0, 0, 1, -r, -r],
                        ["l", 0, r * 2 - h], ["a", r, r, 0, 0, 1, r, -r], ["z"]
                    ];
                }
            ...
            ellipsePath = function(x, y, rx, ry) {
                ...
                return [
                    ["M", x, y], ["m", 0, -ry], ["a", rx, ry, 0, 1, 1, 0, 2 * ry], ["a", rx, ry, 0, 1, 1, 0, -2 * ry],
                    ["z"]
                ];
            },
            getPath = R._getPath = {
        ...
        var preload = R._preload = function(src, f) {
            ...
            img.style.cssText = "left:-9999em;position:absolute;top:-9999em";
            img.onload = function() {
                f.call(this);
                this.onload = null;
                        ...
                        if (p[0] == "M") {
                            ...
                            if (len + l > length) {
                                if (subpath && !subpaths.start) {
                                    ...
                                    subpaths.start = sp;
                                    sp = [
                                        "M" + point.x, point.y + "C" + point.n.x, point.n.y, point.end.x, point.end.y,
                                        p[5], p[6]
                                    ].join();
                                    len += l;
                                    x = +p[5];
                    ...
                    for (var att in params) {
                        if (params[has](att)) {
                            ...
                            case "fill":
                                ...
                                } else if ((o.type == "circle" || o.type == "ellipse" || Str(value).charAt() != "r") &&
...
// └─────────────────────────────────────────────────────────────────────┘ \\
        ...
        (function() {
            ...
            var addArrow = function(o, value, isEnd) {
                ...
                setFillAndStroke = function(o, params) {
                    ...
                    if (res.type == "text") {
                        ...
                        res.textpath.string &&
                        (span.innerHTML = Str(res.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;")
                            .replace(/\n/g, "<br>"));
            ...
            R._engine.create = function() {
                ...
                res.span.style.cssText = "left:-9999em;line-height:1; margin:0;padding:0;position:absolute;top:-9999em;";
