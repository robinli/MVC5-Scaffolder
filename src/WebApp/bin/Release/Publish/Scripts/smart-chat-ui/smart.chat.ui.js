    ...
    $.widget("ui.chatbox",
        {
            options: {
                ...
                messageSent: function(id, user, msg,fromid) {
                    // override this
                    //console.log('sent ', id, user, msg, fromid);
                ...
                boxManager: {
                    ...
                    addMsg: function (peer, msg) {
                        ...
                        if (peer) {
                            ...
                            var peertime = document.createElement("small");
                            var time = document.createTextNode(moment().format('LT'));
                            peertime.appendChild(time);
                            peertime.className = "chat-date";
                            
                            peerName.className = "author-name";
                           
                            $(peerName).text(peer + " " );
                            peerName.appendChild(peertime);
                        ...
                        if (peer == "Me") {
                            ...
                            msgElement.className = "chat-message active";
                            $(e).addClass("left");
                        }
                        $(msgElement).text(msg);
