    ...
    IonRangeSlider.prototype = {
        ...
        calcLabels: function() {
            ...
            if (this.options.type === "single") {
                ...
                this.labels.p_single_left = this.coords.p_single_fake +
        ...
        drawHandles: function() {
            ...
            if (this.old_from !== this.result.from ||
            ...
            if (this.options.type === "single") {
                ...
                if (values_num) {
                    ...
                    if (this.options.decorate_both) {
                        ...
                        text_single =
                            this.decorate(this._prettify(this.result.from) +
                                this.options.values_separator +
        ...
        validate: function() {
            ...
            if (typeof o.keyboard_step !== "number" ||
        ...
        appendGrid: function() {
            ...
            for (i = 0; i < big_num + 1; i++) {
                ...
                html += '<span class="irs-grid-text js-grid-text-' +
                    i +
                    '" style="left: ' +
                    big_w +
                    '%">' +
