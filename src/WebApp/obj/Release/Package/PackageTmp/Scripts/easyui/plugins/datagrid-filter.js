  ...
  var extendedOptions = {
    ...
    defaultFilterOptions: {
      onInit: function (target) {
        ...
        //    input.unbind('.filter').unbind('apply.daterangepicker').bind('apply.daterangepicker', function (e) {
        //        console.log('daterange',input);
        //        var t = $(this);
        //        if (this.timer) {
        //            clearTimeout(this.timer);
        //        }
        ...
        //        }
        //    });
        //    input.unbind('.filter').unbind('cancel.daterangepicker').bind('cancel.daterangepicker', function (e) {
        //        $(this).val('');
        //        var t = $(this);
        //        if (this.timer) {
        //            clearTimeout(this.timer);
        ...
        //    console.log('_doFilterForDateRange');
        //    var rule = $(target)[name]('getFilterRule', field);
        //    var value = input.val();
        //    if (value != '') {
        //        if ((rule && rule.value != value) || !rule) {
  ...
  function resizeFilter(target, field) {
    ...
    ff.each(function () {
      ...
      if (cellWidth != _getContentWidth(cc)) {
        this.filter.resize(this, cellWidth - btn._outerWidth() - 4);//-4px date 10-08
      }
