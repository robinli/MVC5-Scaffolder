...
CKEDITOR.dialog.add("select",
    function(c) {
        ...
        function m(a) {
            for (var a = f(a), b = g(a), e = a.getChildren().count() - 1;
                0 <=
                    e;
        ...
        function k(a) { for (a = f(a); a.getChild(0) && a.getChild(0).remove();); }
        ...
        function l(a) { return(a = f(a)) ? a.getChildren() : !1 }
                                    ...
                                    children: [
                                        {
                                            ...
                                            onClick: function() {
                                                var a = this.getDialog(),
                                                    ...
                                                    a = a.getContentElement("info",
                                                        "cmbValue"),
                                                    c = g(d);
                                                0 <= c &&
                                                (n(d, c, b.getValue(), b.getValue()), n(a,
                                                    c,
                                                    e.getValue(),
                                                    e.getValue()))
                                            }
