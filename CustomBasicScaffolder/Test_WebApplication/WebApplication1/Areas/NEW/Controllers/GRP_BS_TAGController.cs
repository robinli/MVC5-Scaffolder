...
namespace WebApplication1.Areas.NEW.Controllers
{
    public class GRP_BS_TAGController : Controller
    {
        ...
        // GET: NEW/GRP_BS_TAG/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NEW/GRP_BS_TAG/Create
