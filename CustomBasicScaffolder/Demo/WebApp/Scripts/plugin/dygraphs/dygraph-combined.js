 ...
 */
            DygraphOptions.prototype.warnInvalidOption_ = function(optionName) {
                if (!WARNINGS[optionName]) {
                    ...
                    if (isSeries) {
                        console.warn("Use new-style per-series options (saw " +
                            optionName +
 ...
 */
    DygraphCanvasRenderer._drawStyledLine = function(e,
        ...
        var iter = Dygraph.createIterator(points,
            0,
            points.length,
    ...
    Dygraph.prototype.attr_ = function(name, seriesName) {
        if (DEBUG) {
            if (typeof(Dygraph.OPTIONS_REFERENCE) === "undefined") {
                ...
                console.error("Dygraphs is using property " +
                    name +
                    ", which has no " +
 ...
 */
    Dygraph.prototype.createDragInterface_ = function() {
        ...
        for (var eventName in interactionModel) {
            ...
            this.addAndTrackEvent(this.mouseEventElement_,
                eventName,
 ...
 * @private
 */
    Dygraph.prototype.drawZoomRect_ = function(direction,
        startX,
        endX,
        startY,
        endY,
        ...
        if (direction == Dygraph.HORIZONTAL) {
            if (endX && startX) {
                ...
                ctx.fillRect(Math.min(startX, endX),
                    this.layout_.getPlotArea().y,
            ...
            if (endY && startY) {
                ctx.fillStyle = "rgba(128,128,128,0.33)";
                ctx.fillRect(this.layout_.getPlotArea().x,
 ...
 */
    Dygraph.prototype.doZoomXDates_ = function(minDate, maxDate) {
        ...
        this.zoomed_x_ = true;
        var that = this;
        this.doAnimatedZoom(old_window,
            new_window,
            null,
            null,
            function() {
 ...
 */
    Dygraph.prototype.updateSelection_ = function(opt_animFraction) {
        ...
        if (this.getOption("highlightSeriesOpts")) {
            ...
            ctx.clearRect(px - maxCircleSize - 1,
                0,
                2 * maxCircleSize + 2,
                this.height_);
        }
    ...
    Dygraph.prototype.gatherDatasets_ = function(rolledSeries, dateWindow) {
        ...
        for (seriesIdx = num_series; seriesIdx >= 1; seriesIdx--) {
            ...
            if (this.getBooleanOption("stackedGraph")) {
                ...
                Dygraph.stackPoints_(seriesPoints,
                    cumulativeYval[axisIdx],
                    seriesExtremes,
    ...
    Dygraph.prototype.parseCSV_ = function(data) {
        ...
        for (var i = start; i < lines.length; i++) {
            ...
            if (fields.length != expectedCols) {
                console.error("Number of columns in line " +
                    i +
                    " (" +
                    fields.length +
    ...
    Dygraph.prototype.parseArray_ = function(data) {
        ...
        if (this.attr_("labels") === null) {
            ...
            if (num_labels.length != data[0].length) {
                console.error("Mismatch between number of labels (" +
                    num_labels +
                    ")" +
 ...
 */
    Dygraph.dateParser = function(dateStr) {
        ...
        if (dateStr.search("-") != -1) { // e.g. '2009-7-12' or '2009-07-12'
            ...
            dateStrSlashed = dateStr.substr(0, 4) +
                "/" +
                dateStr.substr(4, 2) +
                "/" +
                dateStr.substr(6, 2);
 ...
 */
    ...
    Dygraph.TICK_PLACEMENT[Dygraph.FIVE_MINUTELY] =
        { datefield: Dygraph.DATEFIELD_MM, step: 5, spacing: 1000 * 60 * 5 };
    Dygraph.TICK_PLACEMENT[Dygraph.TEN_MINUTELY] =
        { datefield: Dygraph.DATEFIELD_MM, step: 10, spacing: 1000 * 60 * 10 };
    Dygraph.TICK_PLACEMENT[Dygraph.THIRTY_MINUTELY] =
        { datefield: Dygraph.DATEFIELD_MM, step: 30, spacing: 1000 * 60 * 30 };
            ...
            if (layout.yticks && layout.yticks.length > 0) {
                ...
                for (i = 0; i < layout.yticks.length; i++) {
                    ...
                    */
                    ...
                    if (tick[0] === 0) {
                        label.style.left =
                            (area.x - getAxisOption("axisLabelWidth") - getAxisOption("axisTickSize")) + "px";
...
// Needed for dashed lines.
    var calculateEmWidthInDiv = function(div) {
        ...
        sizeSpan.setAttribute("style", "border: 0;  margin: 0; padding: 0 0 0 1em;");
 ...
 */
    rangeSelector.prototype.resize_ = function() {
        ...
        if (this.dygraph_.getOptionForAxis("drawAxis", "x")) {
            xAxisLabelHeight = this.getOption_("xAxisHeight") ||
                (this.getOption_("axisLabelFontSize") + 2 * this.getOption_("axisTickSize"));
        }
        this.canvasRect_ = {
            x: plotArea.x,
 ...
 */
    rangeSelector.prototype.placeZoomHandles_ = function() {
        ...
        var handleTop = Math.max(this.canvasRect_.y,
            this.canvasRect_.y + (this.canvasRect_.h - this.leftZoomHandle_.height) / 2);
...
Dygraph.OPTIONS_REFERENCE = // <JSON>
{
    ...
    "avoidMinZero": {
        ...
        "type": "boolean",
        "description":
            "Deprecated, please use yRangePad instead. When set, the heuristic that fixes the Y axis at zero for a data set with the minimum Y value of zero is disabled. \nThis is particularly useful for data sets that contain many zero values, especially for step plots which may otherwise have lines not visible running along the bottom axis."
    },
    "drawAxesAtZero": {
        "default": "false",
        "labels": ["Axis display"],
...
/** @inheritDoc */
    DefaultHandler.prototype.rollingAverage = function(originalData,
        rollPeriod,
        options) {
...
/** @inheritDoc */
    DefaultHandler.prototype.getExtremeYValues = function(series,
        dateWindow,
        options) {
 ...
 */
    ...
    DefaultFractionHandler.prototype.rollingAverage = function(originalData,
        rollPeriod,
        options) {
        rollPeriod = Math.min(rollPeriod, originalData.length);
        var rollingData = [];
