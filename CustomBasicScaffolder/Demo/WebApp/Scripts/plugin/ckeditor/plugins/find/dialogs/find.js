    ...
    var o,
        ...
        n = function(c, g) {
            ...
            r.prototype = {
                ...
                clearMatched: function() { this._.isMatched = !1 },
            ...
            var z = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
                ...
                e = {
                    ...
                    find: function(a, b, d, f, e, A) {
                        ...
                        return f && !A
                            ? (this.searchRange = q(1), this.matchRange =
                                null, arguments.callee.apply(this, Array.prototype.slice.call(arguments).concat([!0])))
                            : !1
                    },
                    replaceCounter: 0,
            ...
            return{
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            e.find(a.getValueOf("find", "txtFindFind"),
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            e.replaceCounter
                                                ? (alert(f.replaceSuccessMsg.replace(/%1/, e.replaceCounter)), c.fire(
                                                    "saveSnapshot"))
                                                : alert(f.notFoundMsg)
                                        }
                                    }
                        ...
                        function(f) {
                            return function(e) {
                                ...
                                if (c) {
                                    ...
                                    for (k = 0; k < h; k++)
                                        i = this.getContentElement(u[e], p[k][e]), j =
                                            this.getContentElement(u[g], p[k][g]), j.setValue(i.getValue())
                                }
                            }
                        })
                },
                onShow: function() {
                    ...
                    var a = this.getParentEditor().getSelection().getSelectedText(),
                        b = this.getContentElement(g, "find" == g ? "txtFindFind" : "txtFindReplace");
                    b.setValue(a);
                    b.select();
                    this.selectPage(g);
                ...
                onHide: function() {
                    ...
                    e.matchRange &&
                        ...
                        (e.matchRange.removeHighlight(), c.focus(), (a = e.matchRange.toDomRange()) &&
