...
(function() {
    ...
    var w = function(b) { for (var c in b) b[c].instance.getElement().setText(a.LocalizationComing[c]) },
        x = function(b) {
            for (var c in b) {
        ...
        b.parts.tabs.on("click",
            function(h) {
                ...
                h.data.getTarget().is("a") &&
                    c != b._.currentTabId &&
                    (c = b._.currentTabId, d = b._.contents[c].Content, f =
                        a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount()
                        ? s(a.targetFromFrame[f], a.cmd[c])
                        : (a.setIframe(d, c), g = document.getElementById(f), a.targetFromFrame[f] = g.contentWindow))
            })
    };
    ...
    a.buildOptionLang = function(b, c) {
        ...
        if (0 === d.options.length) {
            ...
            for (var k = 0; k < e.length; k++)
                g = document.createElement("option"), g.setAttribute("value", e[k][1]), h =
                        document.createTextNode(e[k][0]),
                    g.appendChild(h), e[k][1] == a.selectingLang && g.setAttribute("selected", "selected"), f
                        .appendChild(g);
            d.appendChild(f)
        }
    };
    ...
    var o = function(a) {
            ...
            e || d.appendChild(i);
            return{
                setDisable: function() { i.style.display = "none" },
        ...
        z = function(b) {
            if ("no_any_suggestions" == b) {
                ...
                a.LocalizationButton.ChangeTo.instance.enable(),
                    a.LocalizationButton.ChangeAll.instance.enable(), a.LocalizationButton.ChangeTo.instance
                        .getElement()
        ...
        A = {
            ...
            grammerSuggest: function(b) {
                ...
                for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)
                    a.grammerSuggest.getElement().append(y(b[f],
                        b[f],
                        d)), d = !1;
                l();
                a.div_overlay.setDisable()
            ...
            ReplaceText: function(b) {
                ...
                window.setTimeout(function() { a.div_overlay.setDisable() },
                    500);
            ...
            TextCorrect: function() { m(a.langList) }
        },
        B = function(a) {
            a = a || window.event;
        ...
        p = function() { a.dialog.hidePage("GrammTab") },
        r = function() { a.dialog.showPage("SpellTab") },
        l = function() { a.dialog.getContentElement(a.dialog._.currentTabId, "bottomGroup").getElement().show() },
        q = function() {
            a.dialog.getContentElement(a.dialog._.currentTabId,
            ...
            return{
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        onShow: function() {
                                                            j = this;
                                                            this.setValue(!e.cookie.get("udn")
                                                                ? this.getValue()
                                                                : e.cookie.get("udn"));
                ...
                onShow: function() {
                    ...
                    !parseInt(d.IgnoreWordsNumbers, 10)
                        ...
                        : c.IgnoreWordsNumbers.setValue("checked",
                            !1);
