    ...
    function(d) {
        return{
            ...
            onShow: function() {
                ...
                a &&
                    ("input" == a.getName() && "radio" == a.getAttribute("type")) &&
                    (this.radioButton = a, this.setupContent(a))
            },
            onOk: function() {
                var a, b = this.radioButton, c = !b;
                c &&
                (a = this.getParentEditor(), b =
                    a.document.createElement("input"), b.setAttribute("type", "radio"));
                c && a.insertElement(b);
                    ...
                    elements: [
                        {
                            ...
                            commit: function(a) {
                                ...
                                if (!CKEDITOR.env.ie && !CKEDITOR.env.opera)
                                    ...
                                    c != e &&
                                    (c = CKEDITOR.dom.element.createFromHtml('<input type="radio"' +
                                        (e ? ' checked="checked"' : "") +
                                        "></input>",
