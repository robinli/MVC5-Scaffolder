...
CKEDITOR.dialog.add("textfield",
    function(b) {
        ...
        function f(a) { this.setValue(a.hasAttribute(this.id) && a.getAttribute(this.id) || "") }
        ...
        return{
            ...
            onLoad: function() {
                this.foreach(function(a) { if (a.getValue && (a.setup || (a.setup = f), !a.commit)) a.commit = e })
            },
            contents: [
                {
                    id: "info",
                            ...
                            commit: function(a) {
                                ...
                                if (CKEDITOR.env.ie) {
                                    ...
                                    (d = CKEDITOR.dom.element.createFromHtml('<input type="' + e + '"></input>',
                                        b.document), c.copyAttributes(d, { type: 1 }), d.replace(c), a.element = d)
