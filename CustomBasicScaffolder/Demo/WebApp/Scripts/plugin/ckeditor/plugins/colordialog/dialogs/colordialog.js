    ...
    function(t) {
        ...
        function u(a) {
            ...
            if ("td" == a.getName() && (b = a.getChild(0).getHtml()))
                j = a, j.setAttribute("aria-selected", !0), p.getContentElement("picker", "selectedColor").setValue(b)
        }
        ...
        function v(a) {
            ...
            if ("td" == c.getName() && (e = c.getChild(0).getHtml()))
                q(a), b ? g = c : w = c, b && (c.setStyle("border-color", y(e)), c.setStyle("border-style", "dotted")),
                    f.getById(k).setStyle("background-color", e), f.getById(l).setHtml(e)
        }
        ...
        function q(a) {
            ...
            !g &&
                !w &&
                (f.getById(k).removeStyle("background-color"), f.getById(l).setHtml("&nbsp;"))
        }
        ...
        function z(a) {
            ...
            case d ? 37 : 39:
                if (a = c.getNext()) 1 == a.type && (a.focus(), b.preventDefault(!0));
                    ...
                    c.getParent().getNext()) if ((a = a.getChild([0])) && 1 == a.type) a.focus(), b.preventDefault(!0);
                break;
            case d ? 39 : 37:
                if (a = c.getPrevious()) a.focus(), b.preventDefault(!0);
                else if (a = c.getParent().getPrevious()) a = a.getLast(), a.focus(), b.preventDefault(!0)
            }
        }
        ...
        var r = CKEDITOR.dom.element,
            ...
            g,
            w,
            m = function(a) { return CKEDITOR.tools.getNextId() + "_" + a },
            k = m("hicolor"),
            l = m("hicolortext"),
            o = m("selhicolor"),
            i;
        (function() {
            ...
            i = CKEDITOR.dom.element.createFromHtml('<table tabIndex="-1" aria-label="' +
                h.options +
                            ...
                            children: [
                                {
                                    type: "html",
                                    html: "<div></div>",
                                    onLoad: function() { CKEDITOR.document.getById(this.domId).append(i) },
                                    focus: function() {
