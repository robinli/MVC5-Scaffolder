...
(function() {
    ...
    for (var g = 1,
        ...
        j = 0;
        j < m.length;
        j++) n[m[j]] = [{ type: i, name: m[j] }, { type: o, name: m[j] }];
        ...
        function(a) {
            ...
            return{
                ...
                onOk: function() {
                    ...
                    (e = CKEDITOR.dom.element.createFromHtml("<cke:object></cke:object>", a.document),
                        e.setAttributes({
                            classid: "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000",
                            codebase:
                                "http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"
                        })), i)
                        d = CKEDITOR.dom.element.createFromHtml("<cke:embed></cke:embed>", a.document), d.setAttributes(
                            {
                                type: "application/x-shockwave-flash",
                                pluginspage: "http://www.macromedia.com/go/getflashplayer"
                            }), e && d.appendTo(e);
                    if (e)
                        for (var b = {}, c = e.getElementsByTag("param", "cke"), f = 0, j = c.count(); f < j; f++)
                                                    ...
                                                    var a = this.getDialog(),
                                                        b = function(b) {
                                                            ...
                                                            a.preview.setHtml(
                                                                ...
                                                                CKEDITOR.tools.htmlEncode(k.getAttribute("src")) +
                                ...
                                children: [
                                    {
                                        ...
                                        validate: CKEDITOR.dialog.validate.htmlLength(
                                            a.lang.common.invalidHtmlLength.replace("%1",
                                                a.lang.common.width)),
                                        setup: b,
                                        commit: c
                                    },
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [a.lang.common.notSet, ""], [a.lang.flash.windowModeWindow, "window"],
                                    ...
                                    },
                                    {
                                        ...
                                        items: [
                                            ...
                                            [a.lang.flash.qualityAutoLow, "autolow"], [a.lang.flash.qualityLow, "low"]
                                        ],
                                        setup: b,
                                        commit: c
                                    }
                                ...
                                children: [
                                    {
                                        ...
                                        items: [
                                            ...
                                            [a.lang.common.alignMiddle, "middle"], [a.lang.common.alignRight, "right"],
