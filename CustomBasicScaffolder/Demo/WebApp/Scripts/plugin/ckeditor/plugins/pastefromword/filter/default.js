...
(function() {
    function y(a) {
        for (var a = a.toUpperCase(), c = z.length, b = 0, f = 0; f < c; ++f)
            for (var d = z[f], e = d[1].length; a.substr(0, e) == d[1]; a = a.substr(e)) b += d[0];
        return b
    }
            ...
            utils: {
                ...
                resolveList: function(a) {
                    ...
                    if ((b = a.removeAnyChildWithName("cke:listbullet")) &&
                        ...
                        (c.style = E.filters.stylesFilter([
                    ...
                    elements: {
                        ...
                        $: function(a) {
                            ...
                            if (v.match(/h\d/)) {
                                ...
                                if (q(a)) return;
                                g(d["format_" + v])(a)
                            } else if (v in b.$inline) a.filterChildren(c), n(a) && delete a.name;
                                ...
                                (a.replace(/[\n\r]/g, "").replace(/(.+?)\{(.+?)\}/g,
                                    function(a, b, F) {
                                        for (var b = b.split(","), a = b.length, d = 0; d < a; d++)
                                            CKEDITOR.tools.trim(b[d]).replace(/^(\w+)(\.[\w-]+)?$/g,
                                                function(a, b, d) {
                                                    b = b || "*";
                                                    d = d.substring(1, d.length);
                                                    d.match(/MsoNormal/) ||
                                                        (c[b] || (c[b] = {}), d ? c[b][d] = F : c[b] = F)
                                                })
                    ...
                    attributes: {
                        style: j(s
                            ...
                            : [
                                ...
                                ], [/^margin$/, D], ["text-indent", "0cm"], ["page-break-before"], ["tab-stops"], [
                                    "display",
                                    "none"
                                ], o ? [/font-?/] : null
                            ],
