    ...
    $.extend($.jgrid,
        {
            ...
            htmlDecode: function(value) {
                if (value &&
                    (value === "&nbsp;" || value === "&#160;" || (value.length === 1 && value.charCodeAt(0) === 160))) {
                    return "";
                }
                return !value
                    ? value
                ...
                var
                    ...
                    flags = {
                        ...
                        W: N < 5
                            ...
                            : Math.floor((z + N - 1) / 7) || ((new Date(Y - 1, 0, 1).getDay() + 6) % 7 < 4 ? 53 : 52),
                        // Month
            ...
            from: function(source) {
                ...
                var QueryObject = function(d, q) {
                    ...
                    this.startsWith = function(f, v) {
                        ...
                        if (_useProperties) {
                            self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + f + "')") +
                                ".substr(0," +
                                length +
                                ") == " +
        ...
        return this.each(function() {
                    ...
                    populateVisible: function() {
                        ...
                        if (tbot < dh &&
                            ...
                            (p.lastpage === undefined ||
                                parseInt((tbot + scrollTop + div - 1) / div, 10) <= p.lastpage)) {
                        ...
                        if (npage) {
                            if (p.lastpage &&
                                (page > p.lastpage || p.lastpage === 1 || (page === p.page && page === p.lastpage))) {
                                return;
                            }
            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                cellVal = function(val) {
                    return val == null || val === ""
                        ? "&#160;"
                        : (ts.p.autoencode ? $.jgrid.htmlEncode(val) : String(val));
                },
                            ...
                            try {
                                ...
                                for (index = 0; index < group.rules.length; index++) {
                                    ...
                                    if (compareFnMap[rule.op] && rule.field) {
                                        ...
                                        query = compareFnMap[rule.op](query, opr)(rule.field,
                                            rule.data,
                                            cmtypes[rule.field]);
                                    }
                                    s++;
                ...
                updatepager = function(rn, dnd) {
                    ...
                    if (ts.p.scroll) {
                        ...
                        if (rh) {
                            ...
                            $(">div:first", ts.grid.bDiv).css({ height: height }).children("div:first")
                    ...
                    if (pgboxes) {
                        ...
                        if (ts.p.pgbuttons === true) {
                            ...
                            if (cp === 1 || cp === 0) {
                                $("#first" + tspg + ", #prev" + tspg).addClass("ui-state-disabled")
                                    .removeClass("ui-state-hover");
                                if (ts.p.toppager) {
                                    $("#first_t" + tspg_t + ", #prev_t" + tspg_t).addClass("ui-state-disabled")
                                        .removeClass("ui-state-hover");
                                }
                            } else {
                            ...
                            if (cp === last || cp === 0) {
                                $("#next" + tspg + ", #last" + tspg).addClass("ui-state-disabled")
                                    .removeClass("ui-state-hover");
                                if (ts.p.toppager) {
                                    $("#next_t" + tspg_t + ", #last_t" + tspg_t).addClass("ui-state-disabled")
                                        .removeClass("ui-state-hover");
                                }
                            } else {
                ...
                setHeadCheckBox = function(checked) {
                    ...
                    if (fid) {
                        $("#cb_" + $.jgrid.jqID(ts.p.id), ts.grid.fhDiv)[ts.p.useProp ? "prop" : "attr"]("checked",
                            checked);
                    }
                },
                setPager = function(pgid, tp) {
                    ...
                    if (ts.p.viewrecords === true) {
                        $("td#" + pgid + "_" + ts.p.recordpos, "#" + pgcnt).append("<div dir='" +
                            dir +
                            "' style='text-align:" +
                            ts.p.recordpos +
            ...
            for (i = 0; i < ts.p.colModel.length; i++) {
                ts.p.colModel[i] =
                    $.extend(true, {}, ts.p.cmTemplate, ts.p.colModel[i].template || {}, ts.p.colModel[i]);
            ...
            imgs = null;
            $(this).append(thead);
            $("thead tr:first th", this).hover(function() { $(this).addClass("ui-state-hover"); },
                            ...
                            $(ts.rows).each(function(i) {
                                if (i > 0) {
                                    if (!$(this).hasClass("ui-subgrid") &&
                                        ...
                                        $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + $.jgrid.jqID(this.id))[ts.p.useProp
                                            ? "prop"
                                            : "attr"]("checked", true);
                                        ...
                                        ts.p.selrow = this.id;
                                        if (froz) {
                                            $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + $.jgrid.jqID(this.id),
                                                ts.grid.fbDiv)[ts.p.useProp ? "prop" : "attr"]("checked", true);
                                            $("#" + $.jgrid.jqID(this.id), ts.grid.fbDiv)
                            ...
                            $(ts.rows).each(function(i) {
                                if (i > 0) {
                                    if (!$(this).hasClass("ui-subgrid") && !$(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (froz) {
                                            $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + $.jgrid.jqID(this.id),
                                                ts.grid.fbDiv)[ts.p.useProp ? "prop" : "attr"]("checked", false);
                                            $("#" + $.jgrid.jqID(this.id), ts.grid.fbDiv)
            ...
            $(ts).before(grid.hDiv).click(function(e) {
                    ...
                    if ($(ptr).length === 0 ||
                        ptr[0].className.indexOf("ui-state-disabled") > -1 ||
                        ($(td, ts).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !==
                        ts.id) {
                        return this;
                    }
                    ...
                    if (cSel === true) {
                        ...
                        if (ts.p.cellEdit === true) {
                            ...
                            if (ts.p.multiselect && ts.p.multiboxonly) {
                                if (scb) {
                                    ...
                                    $(ts.p.selarrrow).each(function(i, n) {
                                        ...
                                        $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + $.jgrid.jqID(n))[ts.p.useProp
                                            ? "prop"
                                            : "attr"]("checked", false);
                                        if (frz) {
                                            $("#" + $.jgrid.jqID(n), "#" + $.jgrid.jqID(frz))
                                                .removeClass("ui-state-highlight");
                                            $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + $.jgrid.jqID(n),
                                                "#" + $.jgrid.jqID(frz))[ts.p.useProp ? "prop" : "attr"]("checked",
                                                false);
                                        }
                                    });
                                    ts.p.selarrrow = [];
                            ...
                            if (e[ts.p.multikey]) {
                                ...
                                $("#jqg_" + $.jgrid.jqID(ts.p.id) + "_" + ri)[ts.p.useProp ? "prop" : "attr"]("checked",
                                    scb);
                            }
                        }
                    }
            ...
            $(grid.bDiv)
                .append($('<div style="position:relative;' +
                    (isMSIE && $.jgrid.msiever() < 8 ? "height:0.01%;" : "") +
            ...
            var arf = ts.p.hidegrid === true
                ? $("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' />").hover(
            ...
            if (ts.p.toolbar[0]) {
                ...
                if (ts.p.toolbar[1] === "both") {
                    ...
                    $(grid.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id)
                        .insertBefore(grid.hDiv);
                    $(grid.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id)
            ...
            if (ts.p.toppager) {
                ...
                $(grid.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(grid.width)
                    .insertBefore(grid.hDiv);
                        ...
                        if (ts.p.gridstate === "visible") {
                            $(elems, "#gbox_" + $.jgrid.jqID(ts.p.id)).slideUp("fast",
                                function() {
                                    counter--;
                                    if (counter === 0) {
                                        $("span", self).removeClass("ui-icon-circle-triangle-n")
                            ...
                            $(elems, "#gbox_" + $.jgrid.jqID(ts.p.id)).slideDown("fast",
                                function() {
                                    counter--;
                                    if (counter === 0) {
                                        $("span", self).removeClass("ui-icon-circle-triangle-s")
            ...
            return this.each(function() {
                ...
                if (!$t.p.multiselect) {
                    if (pt.className !== "ui-subgrid") {
                        if ($t.p.selrow !== pt.id) {
                            $($($t).jqGrid("getGridRowById", $t.p.selrow)).removeClass("ui-state-highlight")
                                .attr({ "aria-selected": "false", "tabindex": "-1" });
                            $(pt).addClass("ui-state-highlight")
                                .attr({ "aria-selected": "true", "tabindex": "0" }); //.focus();
                            if (fid) {
                                $("#" + $.jgrid.jqID($t.p.selrow), "#" + $.jgrid.jqID(fid))
                                    .removeClass("ui-state-highlight");
                                $("#" + $.jgrid.jqID(selection), "#" + $.jgrid.jqID(fid))
                                    .addClass("ui-state-highlight");
                            }
                            stat = true;
                        } else {
                    ...
                    $("#jqg_" + $.jgrid.jqID($t.p.id) + "_" + $.jgrid.jqID(pt.id))[$t.p.useProp ? "prop" : "attr"](
                        "checked",
                        stat);
                    if (fid) {
                        if (ia === -1) {
                        ...
                        $("#jqg_" + $.jgrid.jqID($t.p.id) + "_" + $.jgrid.jqID(selection), "#" + $.jgrid.jqID(fid))[
        ...
        resetSelection: function(rowid) {
            return this.each(function() {
                ...
                if (rowid !== undefined) {
                    ...
                    if (t.p.multiselect) {
                        $("#jqg_" + $.jgrid.jqID(t.p.id) + "_" + $.jgrid.jqID(sr), "#" + $.jgrid.jqID(t.p.id))[
                            t.p.useProp ? "prop" : "attr"]("checked", false);
                        if (fid) {
                            $("#jqg_" + $.jgrid.jqID(t.p.id) + "_" + $.jgrid.jqID(sr), "#" + $.jgrid.jqID(fid))[
                                t.p.useProp ? "prop" : "attr"]("checked", false);
                        }
                        t.setHeadCheckBox(false);
                    }
                    ...
                    if (t.p.selrow) {
                        $("#" + $.jgrid.jqID(t.p.id) + " tbody:first tr#" + $.jgrid.jqID(t.p.selrow))
                            .removeClass("ui-state-highlight").attr("aria-selected", "false");
                        if (fid) {
                            $("#" + $.jgrid.jqID(t.p.selrow), "#" + $.jgrid.jqID(fid))
                                .removeClass("ui-state-highlight");
                    ...
                    $(t.p.selarrrow).each(function(i, n) {
                        $($(t).jqGrid("getGridRowById", n)).removeClass("ui-state-highlight")
                            .attr("aria-selected", "false");
                        $("#jqg_" + $.jgrid.jqID(t.p.id) + "_" + $.jgrid.jqID(n))[t.p.useProp ? "prop" : "attr"](
                            "checked",
                            false);
                        if (fid) {
                            $("#" + $.jgrid.jqID(n), "#" + $.jgrid.jqID(fid)).removeClass("ui-state-highlight");
                            $("#jqg_" + $.jgrid.jqID(t.p.id) + "_" + $.jgrid.jqID(n), "#" + $.jgrid.jqID(fid))[
                                t.p.useProp ? "prop" : "attr"]("checked", false);
                        }
                    });
                    t.setHeadCheckBox(false);
                ...
                if (data) {
                    try {
                        $(this.p.colModel).each(function(i) {
                            ...
                            if (dval !== undefined) {
                                lcdata[nm] =
                                    this.formatter && typeof this.formatter === "string" && this.formatter === "date"
                    ...
                    if (ind) {
                        ...
                        if (nData !== "" || forceupd === true) {
                            ...
                            if ($t.p.datatype === "local") {
                                ...
                                nData = cm.formatter && typeof cm.formatter === "string" && cm.formatter === "date"
        ...
        clearBeforeUnload: function() {
            return this.each(function() {
                ...
                if ($.isFunction(grid.emptyRows)) {
                    grid.emptyRows.call(this,
                        true,
                        true); // this work quick enough and reduce the size of memory leaks if we have someone
                }
        ...
        setGridState: function(state) {
            return this.each(function() {
                ...
                if (state === "hidden") {
                    ...
                    $(".ui-jqgrid-titlebar-close span", $t.grid.cDiv).removeClass("ui-icon-circle-triangle-n")
                        .addClass("ui-icon-circle-triangle-s");
                    ...
                    $(".ui-jqgrid-titlebar-close span", $t.grid.cDiv).removeClass("ui-icon-circle-triangle-s")
                        .addClass("ui-icon-circle-triangle-n");
        ...
        filterToolbar: function(p) {
            ...
            return this.each(function() {
                ...
                var triggerToolbar = function() {
                        ...
                        $.each($t.p.colModel,
                            function() {
                                var $elem = $("#gs_" + $.jgrid.jqID(this.name),
                                ...
                                if (p.searchOperators) {
                                    ...
                                    so = (this.searchoptions && this.searchoptions.sopt)
                                ...
                                v = this.stype === "custom" &&
                                    ...
                                    $elem.length > 0 &&
                                    $elem[0].nodeName.toUpperCase() === "SPAN"
                                    ? this.searchoptions.custom_value.call($t,
                                        $elem.children(".customelement:first"),
                                        "get")
                                    : $elem.val();
                                if (v || so === "nu" || so === "nn") {
                                    sdata[nm] = v;
                        ...
                        $.each($t.p.colModel,
                            function() {
                                ...
                                case "text":
                                    ...
                                    break;
                                case "custom":
                                    if ($.isFunction(this.searchoptions.custom_value) &&
                                        $elem.length > 0 &&
                                        $elem[0].nodeName.toUpperCase() === "SPAN") {
                                        this.searchoptions.custom_value.call($t,
                                            $elem.children(".customelement:first"),
                    ...
                    function(ci) {
                        ...
                        if (this.search) {
                            ...
                            case "text":
                                ...
                                $("td:eq(1)", stbl).append("<input type='text' style='width:100%;padding:0px;' name='" +
                                    (cm.index || cm.name) +
                                    "' id='gs_" +
                                    cm.name +
                                    "' value='" +
                                ...
                                break;
                            case "custom":
                                $("td:eq(1)", stbl).append("<span style='width:95%;padding:0px;' name='" +
                                    (cm.index || cm.name) +
                                    "' id='gs_" +
                                    cm.name +
                                    "'/>");
                                ...
                                try {
                                    if ($.isFunction(soptions.custom_element)) {
                                        var celm = soptions.custom_element.call($t,
                                    ...
                                    if (e === "e1") {
                                        $.jgrid.info_dialog($.jgrid.errors.errcap,
                                            "function 'custom_element' " + $.jgrid.edit.msg.nodefined,
                                            $.jgrid.edit.bClose);
                                    }
                                    if (e === "e2") {
                                        $.jgrid.info_dialog($.jgrid.errors.errcap,
                                            "function 'custom_element' " + $.jgrid.edit.msg.novalue,
                                            $.jgrid.edit.bClose);
                                    } else {
                                        $.jgrid.info_dialog($.jgrid.errors.errcap,
        ...
        setGroupHeaders: function(o) {
            ...
            return this.each(function() {
                ...
                if ($firstHeaderRow[0] === undefined) {
                    $firstHeaderRow = $("<tr>", { role: "row", "aria-hidden": "true" }).addClass("jqg-first-row-header")
                        .css("height", "auto");
                } else {
                ...
                for (i = 0; i < cml; i++) {
                    ...
                    $("<th>", { role: "gridcell" }).css(thStyle).addClass("ui-first-th-" + ts.p.direction)
        ...
        setFrozenColumns: function() {
            return this.each(function() {
                ...
                if (maxfrozen >= 0 && frozen) {
                    ...
                    $($t).bind("jqGridResizeStop.setFrozenColumns",
                        function(e, w, index) {
                    ...
                    // sorting stuff
                    $($t).bind("jqGridSortCol.setFrozenColumns",
                        function(e, index, idxcol) {

                            var previousSelectedTh =
                                    $("tr.ui-jqgrid-labels:last th:eq(" + $t.p.lastsort + ")", $t.grid.fhDiv),
                    ...
                    $($t).bind("jqGridAfterGridComplete.setFrozenColumns",
                        function() {
...
(function($) {
    ...
    $.jqm = {
        ...
        open: function(s, t) {
            ...
            h.w.css("z-index", z);
            if (c.modal) {
                if (!A[0]) setTimeout(function() { L("bind"); }, 1);
                A.push(s);
            } else if (c.overlay > 0) {
...
var xmlJsonClass = {
    ...
    toJson: function(o, name, ind, wellform) {
        ...
        if (o === "[]") {
            ...
            json += (name ? ":[" : "[") +
                (ar.length > 1
                    ? (newline + ind + tab + ar.join("," + newline + ind + tab) + newline + ind)
                    : ar.join("")) +
                "]";
        } else if (o === null) {
            json += (name && ":") + "null";
            ...
            json += (name ? ":{" : "{") +
                (arr.length > 1
                    ? (newline + ind + tab + arr.join("," + newline + ind + tab) + newline + ind)
                    : arr.join("")) +
                "}";
    ...
    $.fn.fmatter.rowactions = function(act) {
        var $tr = $(this).closest("tr.jqgrow"),
            ...
            $actionsDiv = cm.frozen
                ? $("tr#" + rid + " td:eq(" + $.jgrid.getCellIndex(this) + ") > div", $grid)
                : $(this).parent(),
            op = {
                extraparam: {}
            },
            ...
            hideModal: function(selector, o) {
                ...
                if (o.onClose) {
                    var oncret = o.gb && typeof o.gb === "string" && o.gb.substr(0, 6) === "#gbox_"
                        ? o.onClose.call($("#" + o.gb.substr(6))[0], selector)
                        : o.onClose(selector);
            ...
            createModal: function(aIDs, content, p, insertSelector, posSelector, appendsel, css) {
                ...
                if (p.resize) {
                    if ($.fn.jqResize) {
                        ...
                        $("#" + $.jgrid.jqID(aIDs.themodal)).jqResize(".jqResize",
                    ...
                    $(mw).keydown(function(e) {
                        if (e.which == 27) {
                            ...
                            self.hideModal("#" + $.jgrid.jqID(aIDs.themodal),
                                { gb: p.gbox, jqm: p.jqModal, onClose: cone });
                        }
                    });
                }
            },
...
// Form Functions
            createEl: function(eltype, options, vl, autowidth, ajaxso) {
                ...
                function setAttributes(elm, atr, exl) {
                    var exclude = [
                        "dataInit", "dataEvents", "dataUrl", "buildSelect", "sopt", "searchhidden", "defaultValue",
                        "attr", "custom_element", "custom_value"
                    ];
                ...
                case "select":
                    ...
                    if (options.dataUrl !== undefined) {
                        var rowid = options.name
                                ? String(options.id).substring(0,
                                    String(options.id).length - String(options.name).length - 1)
                                : String(options.id),
                                    ...
                                    if (a) {
                                        ...
                                        setTimeout(function() {
                                                $("option", elem).each(function(i) {
                                                    ...
                                                    if ($.inArray($.trim($(this).text()), ovm) > -1 ||
                                                        $.inArray($.trim($(this).val()), ovm) > -1) {
                        ...
                        if (typeof options.value === "string") {
                            ...
                            for (key in oSv) {
                                if (oSv.hasOwnProperty(key)) {
                                    ...
                                    if (msl &&
                                        ($.inArray($.trim(oSv[key]), ovm) > -1 || $.inArray($.trim(key), ovm) > -1)) {
                                        ov.selected = "selected";
                                    }
                                }
                            }
                    ...
                    inputAddRule.bind("click",
                        function() {
                            ...
                            for (i = 0; i < that.p.columns.length; i++) {
                                ...
                                var searchable = (that.p.columns[i].search === undefined)
                                        ? true
            ...
            this.createTableRowForRule = function(rule, group) {
                ...
                ruleFieldSelect.bind("change",
                    function() {
                        ...
                        $(".input-elm", trpar).bind("change",
                            function(e) {
                                var elem = e.target;
                                rule.data =
                                    elem.nodeName.toUpperCase() === "SPAN" &&
                                    cm.searchoptions &&
                                    $.isFunction(cm.searchoptions.custom_value)
                                    ? cm.searchoptions.custom_value.call($t,
                                        $(elem).children(".customelement:first"),
                                        "get")
                                    : elem.value;
                                that.onchange(); // signals that the filter has changed
                    ...
                    .bind("change",
                        function() {
                            rule.data = cm.inputtype === "custom"
                                ? cm.searchoptions.custom_value.call($t,
                                    $(this).children(".customelement:first"),
                                    "get")
                                : $(this).val();
                            that.onchange(); // signals that the filter has changed
                        });
            ...
            p = $.extend(true,
                {
                    ...
                    sFilter: "filters",
                    loadDefaults:
                        true, // this options activates loading of default filters from grid's postData for Multipe Search only.
                        ...
                        function() {
                            ...
                            if (p.closeAfterSearch) {
                                $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal),
                                    { gb: "#gbox_" + $.jgrid.jqID($t.p.id), jqm: p.jqModal, onClose: p.onClose });
                            }
                            return false;
                        });
                    $("#" + fid + "_reset").bind("click",
                        function() {
                            var sdata = {},
                                fl = $("#" + fid);
                            $t.p.search = false;
        ...
        editGridRow: function(rowid, p) {
            ...
            return this.each(function() {
                ...
                var gID = $t.p.id,
                    ...
                    onInitializeForm = $.isFunction(rp_ge[$t.p.id].onInitializeForm)
                            ...
                            $.each($t.p.colModel,
                                function() {
                                    if (this.name === nm &&
                                        ...
                                        try {
                                            postdata[nm] =
                                                this.editoptions.custom_value.call($t,
                                                    $("#" + $.jgrid.jqID(nm), frmtb),
                                                    "get");
                                            ...
                                            if (e === "e1") {
                                                $.jgrid.info_dialog($.jgrid.errors.errcap,
                                                    "function 'custom_value' " + $.jgrid.edit.msg.novalue,
                                                    $.jgrid.edit.bClose);
                                            } else {
                                                $.jgrid.info_dialog($.jgrid.errors.errcap,
                                                    e.message,
                        ...
                        if (nm !== "cb" && nm !== "subgrid" && this.editable === true && nm !== "rn") {
                            if (ind === false) {
                                ...
                                if (nm === obj.p.ExpandColumn && obj.p.treeGrid === true) {
                                    ...
                                    try {
                                        tmp = $.unformat.call(obj,
                                            $("td[role='gridcell']:eq(" + i + ")", obj.rows[ind]),
                                            { rowId: rowid, colModel: this },
                                            i);
                                    } catch (_) {
                                        tmp = (this.edittype && this.edittype === "textarea")
                                            ? $("td[role='gridcell']:eq(" + i + ")", obj.rows[ind]).text()
                                            : $("td[role='gridcell']:eq(" + i + ")", obj.rows[ind]).html();
                                    }
                                    if (!tmp ||
                                        tmp === "&nbsp;" ||
                                        tmp === "&#160;" ||
                            ...
                            var opt = $.extend({}, this.editoptions || {}, { id: nm, name: nm }),
                                frmopt = $.extend({},
                                    { elmprefix: "", elmsuffix: "", rowabove: false, rowcontent: "" },
                                    this.formoptions || {}),
                            ...
                            if (trdata.length === 0) {
                                trdata = $("<tr " + dc + " rowpos='" + rp + "'></tr>").addClass("FormData")
                                    .attr("id", "tr_" + nm);
                                $(trdata).append(tmpl);
                                $(tb).append(trdata);
                                trdata[0].rp = rp;
                            ...
                            $("td:eq(" + (cp - 2) + ")", trdata[0])
                                .html(frmopt.label === undefined ? obj.p.colNames[i] : frmopt.label);
                        ...
                        if (nm !== "cb" && nm !== "subgrid" && nm !== "rn" && cm[i].editable === true) {
                            ...
                            case "select":
                                ...
                                $("#" + nm + " option", "#" + fmid).each(function() {
                                    ...
                                    ($.trim(tmp) === $.trim($(this).text()) ||
                                        ...
                                        if ($.inArray($.trim($(this).text()), opv) > -1 ||
                            ...
                            case "custom":
                                try {
                                    ...
                                    if (e === "e1") {
                                        $.jgrid.info_dialog($.jgrid.errors.errcap,
                                            "function 'custom_value' " + $.jgrid.edit.msg.nodefined,
                                            $.jgrid.edit.bClose);
                                    } else {
                ...
                function postIt() {
                    ...
                    if (ret[0] && !rp_ge[$t.p.id].processing) {
                        ...
                        postdata[oper] =
                            ($.trim(postdata[$t.p.id + "_id"]) === "_empty") ? opers.addoper : opers.editoper;
                        ...
                        if ($t.p.treeGrid === true) {
                            if (postdata[oper] === opers.addoper) {
                                ...
                                var tr_par_id = $t.p.treeGridModel === "adjacency"
                                        ...
                                        if ($.isFunction(rp_ge[$t.p.id].afterComplete)) {
                                            ...
                                            setTimeout(function() {
                                                    $($t).triggerHandler("jqGridAddEditAfterComplete",
                                                        [copydata, postdata, $("#" + frmgr), frmoper]);
                                                    rp_ge[$t.p.id].afterComplete.call($t,
                                                        copydata,
                                                        postdata,
                                                        $("#" + frmgr),
                                                        frmoper);
                                        ...
                                        if (rp_ge[$t.p.id].checkOnSubmit || rp_ge[$t.p.id].checkOnUpdate) {
                                            ...
                                            if (rp_ge[$t.p.id]._savedData[$t.p.id + "_id"] !== "_empty") {
                                                for (key in rp_ge[$t.p.id]._savedData) {
                                                    if (rp_ge[$t.p.id]._savedData.hasOwnProperty(key) &&
                                                        postdata[key]) {
                ...
                function updateNav(cr, posarr) {
                    ...
                    if (cr === 0) {
                        ...
                        $("#" + $.jgrid.jqID(posarr[1][cr - 1])).hasClass("ui-state-disabled")) {
                        $("#pData", frmtb + "_2").addClass("ui-state-disabled");
                    } else {
                ...
                $("#" + $.jgrid.jqID(IDs.themodal)).keydown(function(e) {
                    ...
                    if (e.which === 27) {
                        ...
                        if (cle) {
                            $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal),
                                { gb: p.gbox, jqm: p.jqModal, onClose: rp_ge[$t.p.id].onClose });
                        }
                        return false;
                    }
                ...
                if (p.checkOnUpdate) {
                    ...
                    $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(IDs.themodal)).unbind("click")
                        .click(function() {
                            ...
                            $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal),
                                { gb: "#gbox_" + $.jgrid.jqID(gID), jqm: p.jqModal, onClose: rp_ge[$t.p.id].onClose });
                            return false;
                        });
                }
                ...
                if (p.saveicon[0] === true) {
                    $("#sData", frmtb + "_2")
                        .addClass(p.saveicon[1] === "right" ? "fm-button-icon-right" : "fm-button-icon-left")
                        .append("<span class='ui-icon " + p.saveicon[2] + "'></span>");
                }
                if (p.closeicon[0] === true) {
                    $("#cData", frmtb + "_2")
                        .addClass(p.closeicon[1] === "right" ? "fm-button-icon-right" : "fm-button-icon-left")
            ...
            return this.each(function() {
                ...
                function createData(rowid, obj, tb, maxcols) {
                    var nm,
                        ...
                        ind = false,
                        i,
                        tdtmpl = "<td class='CaptionTD form-view-label ui-widget-content' width='" +
                            p.labelswidth +
                    ...
                    $(obj.p.colModel).each(function(i) {
                        ...
                        if (nm !== "cb" && nm !== "subgrid" && nm !== "rn" && viewfld) {
                            ...
                            $("td:eq(" + (cp - 2) + ")", trdata[0]).html("<b>" +
                                (frmopt.label === undefined ? obj.p.colNames[i] : frmopt.label) +
                                "</b>");
                            $("td:eq(" + (cp - 1) + ")", trdata[0]).append("<span>" + tmp + "</span>")
                                .attr("id", "v_" + nm);
                            if (setme) {
                                $("td:eq(" + (cp - 1) + ") span", trdata[0])
                                    .css({ 'text-align': "right", width: maxw + "px" });
                            }
                            retpos[cnt] = i;
                            cnt++;
                        }
                ...
                p.gbox = "#gbox_" + $.jgrid.jqID(gID);
                var bt = $("<div></div>").append(frm).append("<table border='0' class='EditTable' id='" +
                    frmtb +
                ...
                $("#" + IDs.themodal).keydown(function(e) {
                    if (e.which === 27) {
                        if (rp_ge[$t.p.id].closeOnEscape) {
                            $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal),
                                { gb: p.gbox, jqm: p.jqModal, onClose: p.onClose });
                        }
                        return false;
                    }
                    if (p.navkeys[0] === true) {
                ...
                $("#cData", "#" + frmtb + "_2").click(function() {
                    $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal),
                        { gb: "#gbox_" + $.jgrid.jqID(gID), jqm: p.jqModal, onClose: p.onClose });
                    return false;
                });
                $("#nData", "#" + frmtb + "_2").click(function() {
                    $("#FormError", "#" + frmtb).hide();
        ...
        delGridRow: function(rowids, p) {
            ...
            return this.each(function() {
                ...
                if ($("#" + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
                    ...
                    if (p.delicon[0] === true) {
                        $("#dData", "#" + dtbl + "_2")
                            .addClass(p.delicon[1] === "right" ? "fm-button-icon-right" : "fm-button-icon-left")
                            .append("<span class='ui-icon " + p.delicon[2] + "'></span>");
                    }
                    if (p.cancelicon[0] === true) {
                        $("#eData", "#" + dtbl + "_2")
                            .addClass(p.cancelicon[1] === "right" ? "fm-button-icon-right" : "fm-button-icon-left")
            ...
            return this.each(function() {
                ...
                for (i = 0; i < clone; i++) {
                    ...
                    if (o.add) {
                        ...
                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon " +
                            o.addicon +
                            "'></span>" +
                            o.addtext +
                            "</div>");
                                ...
                                if (!$(this).hasClass("ui-state-disabled")) {
                                    ...
                                    if (sr) {
                                        ...
                                        $.jgrid.viewModal("#" + alertIDs.themodal,
                                            { gbox: "#gbox_" + $.jgrid.jqID($t.p.id), jqm: true });
                                        $("#jqg_alrt").focus();
                                    }
                                }
                                return false;
                ...
                if (rowdata) {
                    for (i in rowdata) {
                        if (rowdata.hasOwnProperty(i)) {
                            if ($("[name=" + $.jgrid.jqID(i) + "]", formid).is("input:radio") ||
...
//Editing
                ...
                if (cv[0] === false) {
                    try {
                        ...
                        $.jgrid.info_dialog($.jgrid.errors.errcap,
                            cv[1],
                            $.jgrid.edit.bClose,
                            { left: positions[0], top: positions[1] + $(tr).outerHeight() });
                    } catch (e) {
                        alert(cv[1]);
                    }
                    return success;
                    ...
                    $.ajax($.extend({
                            ...
                            error: function(res, stat, err) {
                                ...
                                if ($.isFunction(o.errorfunc)) {
                                    ...
                                    try {
                                        $.jgrid.info_dialog($.jgrid.errors.errcap,
                                            '<div class="ui-state-error">' + rT + "</div>",
                                            $.jgrid.edit.bClose,
                                            { buttonalign: "right" });
                                    } catch (e) {
                                        alert(rT);
        ...
        addRow: function(p) {
            ...
            return this.each(function() {
                ...
                p.rowID =
                    $.isFunction(p.rowID) ? p.rowID.call($t, p) : ((p.rowID != null) ? p.rowID : $.jgrid.randId());
            ...
            return this.each(function() {
                ...
                if (fr !== null) {
                    ...
                    if (v2 !== $t.p.savedRow[fr].v) {
                        ...
                        if (cv[0] === true) {
                            var addpost = $($t).triggerHandler("jqGridBeforeSubmitCell",
                                    [$t.rows[iRow].id, nm, v, iRow, iCol]) ||
                                {};
                                ...
                                if ($t.p.cellurl) {
                                    ...
                                    $.ajax($.extend({
                                            ...
                                            data: $.isFunction($t.p.serializeCellData)
                                                ? $t.p.serializeCellData.call($t, postdata)
                                                : postdata,
                                            type: "POST",
                                            complete: function(result, stat) {
                                                ...
                                                if (stat === "success") {
                                                    var ret = $($t).triggerHandler("jqGridAfterSubmitCell",
                                                            [$t, result, postdata.id, nm, v, iRow, iCol]) ||
                                                        [true, ""];
                                                    if (ret[0] === true && $.isFunction($t.p.afterSubmitCell)) {
                                                        ret = $t.p.afterSubmitCell.call($t,
                                                            result,
                                                            postdata.id,
                                                            nm,
                                                            v,
                                            ...
                                            error: function(res, stat, err) {
                                                ...
                                                if ($.isFunction($t.p.errorCell)) {
                                                    ...
                                                    $.jgrid.info_dialog($.jgrid.errors.errcap,
                                                        res.status + " : " + res.statusText + "<br/>" + stat,
                                                        $.jgrid.edit.bClose);
                                                    $($t).jqGrid("restoreCell", iRow, iCol);
                                                }
                                            }
                    ...
                    if (tp === "h") {
                        ...
                        if (nCOL >= cw + parseInt(sl, 10)) {
                            $($t.grid.bDiv)[0].scrollLeft =
                                $($t.grid.bDiv)[0].scrollLeft + $t.rows[iR].cells[iC].clientWidth;
                        } else if (pCOL < sl) {
                            $($t.grid.bDiv)[0].scrollLeft =
                                $($t.grid.bDiv)[0].scrollLeft - $t.rows[iR].cells[iC].clientWidth;
                        }
            ...
            return this.each(function() {
                            ...
                            for (i = 0; i < ts.p.colModel.length; i++) {
                                if (ts.p.colModel[i].name === ts.p.subGridModel[0].params[j]) {
                                    dp[ts.p.colModel[i].name] =
                                        $("td:eq(" + i + ")", rd).text().replace(/\&#160\;/ig, "");
                                }
                            }
                        }
                    }
                ...
                while (i < len) {
                    if ($(ts.rows[i]).hasClass("jqgrow")) {
                        $(ts.rows[i].cells[pos]).bind("click",
                            function() {
                                ...
                                if ($(this).hasClass("sgcollapsed")) {
                                    ...
                                    (ts.p.subGridOptions.reloadOnExpand === false &&
                                        ...
                                        bfsc =
                                            $(ts).triggerHandler("jqGridSubGridBeforeExpand", [pID + "_" + _id, _id]);
                                        ...
                                        $(tr).after("<tr role='row' class='ui-subgrid'>" +
                                            atd +
                                    ...
                                    $(this).html("<a style='cursor:pointer;'><span class='ui-icon " +
    ...
    $.jgrid.extend({
        setTreeNode: function(i, len) {
            return this.each(function() {
                ...
                while (i < len) {
                    ...
                    twrap += "></div></div>";
                    $($t.rows[i].cells[expCol]).wrapInner("<span class='cell-wrapper" + lf + "'></span>")
                        .prepend(twrap);
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                $t.p.treeIcons = $.extend({ plus: pico, minus: "ui-icon-triangle-1-s", leaf: "ui-icon-radio-off" },
                    $t.p.treeIcons || {});
                if ($t.p.treeGridModel === "nested") {
            ...
            this.each(function() {
                ...
                case "nested":
                    ...
                    $(this.p.data).each(function() {
                        if (parseInt(this[levelc], 10) === level - 1 &&
            ...
            this.each(function() {
                ...
                case "nested":
                    var lftc = $t.p.treeReader.left_field,
                        ...
                        level = parseInt(rc[levelc], 10);
                    $(this.p.data).each(function() {
                        if (parseInt(this[levelc], 10) >= level &&
                            parseInt(this[lftc], 10) >= lft &&
            ...
            return this.each(function() {
                ...
                if (!rc[expanded]) {
                    ...
                    if ($(this).jqGrid("isNodeLoaded", this.p.data[position])) {
                        rc[expanded] = true;
                        $("div.treeclick", rc1).removeClass(this.p.treeIcons.plus + " tree-plus")
                        ...
                        if (this.p.treeGridModel === "nested") {
                            $(this).jqGrid("setGridParam",
                                { postData: { nodeid: id, n_left: rc[lft], n_right: rc[rgt], n_level: rc[level] } });
                        } else {
                            $(this).jqGrid("setGridParam",
        ...
        collapseNode: function(rc) {
            return this.each(function() {
                ...
                if (rc[expanded]) {
                    ...
                    var id = $.jgrid.getAccessor(rc, this.p.localReader.id);
                    var rc1 = $("#" + this.p.idPrefix + $.jgrid.jqID(id), this.grid.bDiv)[0];
                    $("div.treeclick", rc1).removeClass(this.p.treeIcons.minus + " tree-minus")
            ...
            return this.each(function() {
                ...
                $.each(records,
                    function(index) {
                        ...
                        $("#" + $.jgrid.jqID($t.p.id) + " tbody tr:eq(" + index + ")")
                            .after($("tr#" + $.jgrid.jqID(id), $t.grid.bDiv));
                    });
                query = null;
                roots = null;
                records = null;
                ...
                if (parentid === undefined || parentid === null || parentid === "") {
                    ...
                    if (parentdata[isLeaf]) {
                        ...
                        $($t.rows[prow])
                            ...
                            .end()
                            .find("div.tree-leaf").removeClass($t.p.treeIcons.leaf + " tree-leaf")
                    ...
                    if (parentid !== null) {
                        ...
                        if (res.length) {
                            for (key in res) {
                                if (res.hasOwnProperty(key)) {
                                    res[key][left] =
                                        res[key][left] > maxright ? parseInt(res[key][left], 10) + 2 : res[key][left];
                                    res[key][right] =
                        ...
                        for (i = 0; i < grp.groupField.length; i++) {
                            ...
                            if (grp.groupColumnShow[i] === true) {
                                ...
                                grp.visibiltyOnNextGrouping[i] =
                                    $("#" + $.jgrid.jqID($t.p.id + "_" + grp.groupField[i])).is(":visible");
                ...
                for (i = 0; i < grlen; i++) {
                    ...
                    if (v !== undefined) {
                        if (irow === 0) {
                            ...
                            $.each(grp.counters[i].summary,
                                function() {
                                    if ($.isFunction(this.st)) {
                                        this.v = this.st.call($t, this.v, this.nm, record);
                                    } else {
                                        this.v = $($t).jqGrid("groupingCalculations.handler",
                                            this.st,
                                            this.v,
                                            this.nm,
                                            this.sr,
                                        ...
                                        if (this.st.toLowerCase() === "avg" && this.sd) {
                                            this.vd = $($t).jqGrid("groupingCalculations.handler",
                                                this.st,
                                                this.vd,
                                                this.sd,
                                                this.sr,
                            ...
                            if (typeof v !== "object" &&
                            ($.isArray(grp.isInTheSameGroup) && $.isFunction(grp.isInTheSameGroup[i])
                                ? ! grp.isInTheSameGroup[i].call($t, grp.lastvalues[i], v, i, grp)
                                : grp.lastvalues[i] !== v)) {
                    ...
                    if (r) {
                        ...
                        while (r) {
                            ...
                            if (showData === undefined) {
                                showData =
                                    itemGroupingLevel ===
                                    undefined; // if the first row after the opening group is data row then show the data rows
                            }
                            if (itemGroupingLevel !== undefined) {
                                ...
                                if (itemGroupingLevel === num + 1) {
                                    $(r).show().find(">td>span." + "tree-wrap-" + $t.p.direction).removeClass(minus)
                                        .addClass(plus);
                                    if (frz) {
                                        $(r2).show().find(">td>span." + "tree-wrap-" + $t.p.direction)
                    ...
                    function(i, n) {
                        ...
                        try {
                            if ($.isArray(grp.formatDisplayField) && $.isFunction(grp.formatDisplayField[n.idx])) {
                                n.displayValue = grp.formatDisplayField[n.idx].call($t,
                                    n.displayValue,
                                    n.value,
        ...
        groupingGroupBy: function(name, options) {
            return this.each(function() {
                ...
                for (i = 0; i < name.length; i++) {
                    grp.visibiltyOnNextGrouping[i] =
                        $("#" + $.jgrid.jqID($t.p.id) + "_" + $.jgrid.jqID(name[i])).is(":visible");
                }
        ...
        gridDnD: function(opts) {
            return this.each(function() {
                ...
                function updateDnD() {
                    ...
                    $("tr.jqgrow:not(.ui-draggable)", $t).draggable($.isFunction(datadnd.drag)
                            ...
                            return $.extend({
                                    start: function(ev, ui) {
                                        ...
                                        for (i = 0; i < $.data($t, "dnd").connectWith.length; i++) {
                                            if ($($.data($t, "dnd").connectWith[i])
                                                .jqGrid("getGridParam", "reccount") ===
                                                0) {
                                                $($.data($t, "dnd").connectWith[i])
                                                    .jqGrid("addRowData", "jqg_empty_row", {});
                                            }
                                        }
                            ...
                            return $.extend({
                                    ...
                                    drop: function(ev, ui) {
                                        ...
                                        if (!opts.dropbyname) {
                                            ...
                                            var dropmodel = $("#" + $.jgrid.jqID(this.id))
                                        ...
                                        if (opts.beforedrop && $.isFunction(opts.beforedrop)) {
                                            ...
                                            var datatoinsert = opts.beforedrop.call(this,
                                                ev,
                                                ui,
                                                getdata,
                                                $("#" + $.jgrid.jqID($t.p.id)),
                                        ...
                                        if (ui.helper.dropped) {
                                            ...
                                            $("#" + $.jgrid.jqID(this.id))
                                                .jqGrid("addRowData", grid, getdata, opts.droppos);
                                        }
                ...
                function agregateFunc(row, aggr, value, curr) {
                    ...
                    for (j = 0; j < jv; j++) {
                        ...
                        for (i = 0; i < arrln; i++) {
                            ...
                            curr[label] = tmpmember[label] =
                                calculation(aggr[i].aggregator, curr[label], aggr[i].member, row);
                        }
                        member[vl] = tmpmember;
                    }
                    return curr;
                            ...
                            if (typeof items[key] !== "object") {
                                ...
                                if (key === "level") {
                                    ...
                                    if (lastval[items.level] !== items.text &&
                                        ...
                                        if (items.level > 0) {
                                            ...
                                            headers[items.level - 1].groupHeaders[collen - 1].startColumnName =
                                                columns[colpos].name;
                                            headers[items.level - 1].groupHeaders[collen - 1].numberOfColumns =
                                                columns.length - colpos;
                                ...
                                if (items.level === ylen && key === "level" && ylen > 0) {
                                    if (aggrlen > 1) {
                                        ...
                                        headers[ylen - 1].groupHeaders[headers[ylen - 1].groupHeaders.length - 1]
                ...
                if (typeof data === "string") {
                    $.ajax($.extend({
                            ...
                            success: function(response) {
                                pivot($.jgrid.getAccessor(response,
