...
(function($) {
    ...
    Progressbar.prototype.transition = function() {
        ...
        var update = options.update && typeof options.update === "function"
            ? options.update
        ...
        setTimeout(function() {
                ...
                var progress = setInterval(function() {
                        ...
                        current_value =
                            Math.round(aria_valuemin + this_size / parent_size * (aria_valuemax - aria_valuemin));
                        ...
                        if (options.display_text !== "none") {
                            text = options.use_percentage
                                ...
                                : options.amount_format(current_value, aria_valuemax, aria_valuemin);
