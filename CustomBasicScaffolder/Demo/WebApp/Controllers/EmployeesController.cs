...
namespace WebApp.Controllers
{
	public class EmployeesController : Controller
	{
		...
		public async Task<ActionResult> Index()
		{
			...
			var employees  = _employeeService.Queryable().Include(e => e.Company);
		...
		public async Task<ActionResult> Create([Bind(Include = "Company,Id,Name,Sex,Age,Brithday,CompanyId")] Employee employee)
		{
		...
		[HttpPost]
		//[ValidateAntiForgeryToken]
		public async Task<ActionResult> Edit([Bind(Include = "Company,Id,Name,Sex,Age,Brithday,CompanyId")] Employee employee)
		{
			if (ModelState.IsValid)
			{
