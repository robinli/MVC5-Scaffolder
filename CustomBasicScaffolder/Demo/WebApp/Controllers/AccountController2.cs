...
namespace WebApp.Controllers
{
    ...
    public class AccountController2 : Controller
    {
        ...
        public AccountController2(ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, AccountType=0 };
